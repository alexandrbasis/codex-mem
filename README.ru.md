...
Версия `1.3.0` добавляет навык обслуживания и диагностику без изменения данных. Сбор, обработка и поиск сохраняют проверенное поведение снимка `1.2.0`. Нативная интеграция проверена на Codex CLI `0.153.4`; эта версия задаёт границу подтверждённой совместимости.
