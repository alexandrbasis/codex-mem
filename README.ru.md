...
Локальная память для Codex: найти прошлые решения, сохранить проверенный опыт и восстановить контекст в следующей сессии. Новая реализация по мотивам Claude Mem, предназначенная для Codex CLI и Codex desktop на macOS/Linux.
