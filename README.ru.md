...
Версия `1.4.0` добавляет хранение исходных входов и результатов инструментов, структурированные наблюдения, отдельные итоги сессии и фильтры по файлам, понятиям и типам. Обработчик использует Luna с reasoning `medium`. Сырой журнал доступен для явного просмотра и исключён из обычного поиска, автоматического контекста и семантического индекса. Граница нативной совместимости — Codex CLI `0.153.4`.
